defmodule Kansoku.RuntimeSettings do
  @moduledoc """
  ...
  @type projection :: %{
          kansoku_version: String.t(),
          jizoku_version: String.t(),
  ...
  def project(settings, opts \\ []) when is_map(settings) and is_list(opts) do
    ...
    jizoku_version = version(:jizoku)

    %{
      kansoku_version: version(:kansoku),
      jizoku_version: jizoku_version,
